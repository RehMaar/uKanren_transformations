...
let rec int2nat n = if n <= 0 then zero else s (int2nat (n - 1))
...
let _ =
  full_run (1) q qh ("CPD answers1", (fun q -> topLevel q t1 t1'));
  full_run (1) q qh ("SU  answers1", (fun q -> topLevelSU q t1 t1'));
  full_run (1) q qh ("RU  answers1", (fun q -> topLevelRU q t1 t1'));
(*
CPD answers1, 1 answer {
q=[Some (C 1 [])] ^ _.120;
}
SU  answers1, 1 answer {
q=[Some (C 1 [])] ^ _.291;
}
*)

  full_run (1) q qh ("CPD answers2", (fun q -> topLevel q t2 t2'));
  full_run (1) q qh ("SU  answers2", (fun q -> topLevelSU q t2 t2'));
  full_run (1) q qh ("RU  answers2", (fun q -> topLevelRU q t2 t2'));
(*
CPD answers2, 1 answer {
q=[Some (C 4 []); Some (C 2 [C 5 []; C 3 []]); Some (C 2 [C 6 []; C 2 [C 7 []; C 3 []]]); None; Some (C 2 [C 4 []; V 3])] ^ _.5563;
}
SU  answers2, 1 answer {
q=[Some (C 4 []); Some (C 2 [C 5 []; C 3 []]); Some (C 2 [C 6 []; C 2 [C 7 []; C 3 []]]); Some (C 0 []); Some (C 2 [C 4 []; C 0 []])] ^ _.26821;
}
*)

  full_run (1) q qh ("CPD answers3", (fun q -> topLevel q t3 t3'));
  full_run (1) q qh ("RU  answers3", (fun q -> topLevelRU q t3 t3'));
  full_run (1) q qh ("SU  answers3", (fun q -> topLevelSU q t3 t3'));
(*

CPD answers3, 1 answer {
q=[Some (C 1 [C 2 []; C 3 []]); Some (V 0); Some (C 3 []); Some (C 2 [])] ^ _.135226;
}
SU  answers3, 1 answer {
