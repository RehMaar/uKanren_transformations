...
let result_elem2 = run q (fun q -> topLevelMy q list (!!false)) id
let result_elem22 = run q (fun q -> topLevelCPD q list (!!false)) id

let result_elem3 = run q (fun q -> topLevelMy p1 q (!!true)) id
...
let _ = Printf.printf "\nTest elem\n-----------\n";
        ...
        L.iter (fun c -> Printf.printf "My:  (1,1) `elem` x -> %s\n"
...
let topLevelMy2 z1 z2 =
  let rec isPath z1 z2 = fresh (q1 q2 q3 q4) (z1 === nil () ||| (z1 === q1 % nil ()) ||| (z1 === q2 % (q3 % q4) &&& isPath (q3 % q4) z2 &&& elem q2 q3 z2))
  and elem z1 z2 z3 =
    fresh (q1 q2 q3 q4)
      ( z3
      === pair q1 q2 % q3
      &&& eqNatEqNat z1 q1 z2 q2
      ||| (z3 === pair q2 q4 % q3 &&& elem z1 z2 q3 &&& _eqNatEqNat z1 q2 z2 q4)
      ||| (z3 === pair q2 q4 % q3 &&& elem z1 z2 q3 &&& __eqNatEqNat z1 q2 z2 q4) )
  and eqNatEqNat z1 z2 z3 z4 = fresh (q1 q2) (z1 === zero &&& (z2 === zero) &&& eqNat z3 z4 ||| (z1 === s q1 &&& (z2 === s q2) &&& eqNatEqNat q1 q2 z3 z4))
  and eqNat z1 z2 = fresh (q1 q2) (z1 === zero &&& (z2 === zero) ||| (z1 === s q1 &&& (z2 === s q2) &&& eqNat q1 q2))
  and _eqNatEqNat z1 z2 z3 z4 =
    fresh (q1 q2 q3 q4)
      ( z1 === s q1 &&& (z2 === zero) &&& _eqNat z3 z4
      ||| (z1 === zero &&& (z2 === s q2) &&& _eqNat z3 z4)
      ||| (z1 === s q3 &&& (z2 === s q4) &&& _eqNatEqNat q3 q4 z3 z4) )
  and _eqNat z1 z2 =
    fresh (q1 q2 q3 q4)
      ( z1 === zero &&& (z2 === zero)
      ||| (z1 === s q1 &&& (z2 === zero))
      ||| (z1 === zero &&& (z2 === s q2))
      ||| (z1 === s q3 &&& (z2 === s q4) &&& _eqNat q3 q4) )
  and __eqNatEqNat z1 z2 z3 z4 =
    fresh (q1 q2) (z1 === zero &&& (z2 === zero) &&& __eqNat z3 z4 ||| (z1 === s q1 &&& (z2 === s q2) &&& __eqNatEqNat q1 q2 z3 z4))
  and __eqNat z1 z2 =
    fresh (q1 q2 q3 q4) (z1 === s q1 &&& (z2 === zero) ||| (z1 === zero &&& (z2 === s q2)) ||| (z1 === s q3 &&& (z2 === s q4) &&& __eqNat q3 q4))
  in
  isPath z1 z2

let topLevelMy3 x0 x1 =
