...
toplevelGoal = fresh ["subst", "fml", "res"] (call "check_subst" [V "subst", V "fml", V "res"])

av = fresh ["x", "y"] (call "all_vars" [V "x", V "y"] )


avavapp = fresh ["x", "y", "z", "t", "r"] (call "all_vars" [V "x", V "y"] &&& call "all_vars" [V "z", V "t"] &&& call "append" [V "y", V "t", V "r"] )

simplGoal = fresh ["x"] (call "f" [V "x"] &&& call "f" [V "x"] &&& call "h" [V "x"] )
...
logic_interpreter =
 (\last_goal ->
  ...
  -- ,
  --
  -- "open MiniKanren\nopen MiniKanrenStd\ntype ('a, 'a0) gexpression =\n  | I \n  | O \n  | Var of 'a \n  | Not of 'a0 \n  | Conj of 'a0 * 'a0 \n  | Disj of 'a0 * 'a0 \nlet rec fmap fa fa0 =\n  function\n  | I -> I\n  | O -> O\n  | Var a -> Var (fa a)\n  | Not a0 -> Not (fa0 a0)\n  | Conj (a0_0, a0_1) -> Conj ((fa0 a0_0), (fa0 a0_1))\n  | Disj (a0_0, a0_1) -> Disj ((fa0 a0_0), (fa0 a0_1))\nmodule For_gexpression =\n  (Fmap2)(struct\n            let rec fmap fa fa0 =\n              function\n              | I -> I\n              | O -> O\n              | Var a -> Var (fa a)\n              | Not a0 -> Not (fa0 a0)\n              | Conj (a0_0, a0_1) -> Conj ((fa0 a0_0), (fa0 a0_1))\n              | Disj (a0_0, a0_1) -> Disj ((fa0 a0_0), (fa0 a0_1))\n            type ('a, 'a0) t = ('a, 'a0) gexpression\n          end)\nlet rec i () = inj (For_gexpression.distrib I)\nand o () = inj (For_gexpression.distrib O)\nand var x__0 = inj (For_gexpression.distrib (Var x__0))\nand not_ x__0 = inj (For_gexpression.distrib (Not x__0))\nand conj_ x__0 x__1 = inj (For_gexpression.distrib (Conj (x__0, x__1)))\nand disj x__0 x__1 = inj (For_gexpression.distrib (Disj (x__0, x__1)))\ntype 'a0 gnat =\n  | S of 'a0 \n  | Z \nlet rec fmap fa0 = function | S a0 -> S (fa0 a0) | Z -> Z\nmodule For_gnat =\n  (Fmap)(struct\n           let rec fmap fa0 = function | S a0 -> S (fa0 a0) | Z -> Z\n           type 'a0 t = 'a0 gnat\n         end)\nlet rec s x__0 = inj (For_gnat.distrib (S x__0))\nand z () = inj (For_gnat.distrib Z)")
